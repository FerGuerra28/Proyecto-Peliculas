...
<div class="remodal" data-remodal-id="modal<?php echo $row[0] ?>" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
  ...
  <div>
    <h2 id="modal1Title">Modificar Critica</h2>
    <p id="modal1Desc">
      </br>
      <form class="form-horizontal" action="../controlador/critica_pelicula_controlador.php" method="post" data-toggle="validator">
