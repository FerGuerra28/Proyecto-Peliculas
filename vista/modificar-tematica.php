...
<input value="<?=$r[0]?>" type="hidden" name="idpelicula" />
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-md-5" >
                        <input value="<?=$r[1]?>" id="title" name="txttematica" type="text" placeholder="Titulo" class="form-control input-md" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                      <input value="<?=$r[2]?>" id="fecha1" onchange="ValidarFechaInicial();" name="txtfecha1" type="text" placeholder="Fecha de inicio" class="form-control input-md" required>
                        </div>
                        <div class="help-block with-errors"></div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <input value="<?=$r[3]?>" id="fecha2" onchange="ValidarFechaFinal();" name="txtfecha2" type="text" placeholder="Fecha final" class="form-control input-md"  required>
                        </div>
                        <div class="help-block with-errors"></div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          ...
                          <button class="remodal-confirm" type="submit" name="action" value="modificar">Guardar</button>
