...
<div id="page-content-wrapper">
      ...
      <div class="panel-heading" style="background-color:black; "><h3 style="text-align:center;">Resgistra una Pelicula</h3></div>
      </div>

  <form class="form-horizontal" action="../controlador/peliculacontrolador.php" method="post" data-toggle="validator" enctype="multipart/form-data">
        ...
        <div class="form-group" >
          ...
          <div class="col-md-5" >
          <input id="durac" name="txtdurac" type="text" placeholder="Duracion" class="form-control input-md" required>
          </div>
          <div class="help-block with-errors"></div>
        </div>
        <div class="form-group" >
          ...
          <div class="col-md-5" >
          <input id="punt" name="txtpunt" type="text" placeholder="Puntuacion" class="form-control input-md" required>
          </div>
          <div class="help-block with-errors"></div>
        </div>
